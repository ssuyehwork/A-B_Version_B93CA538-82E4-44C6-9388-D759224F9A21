# 代码导出结果 - 20260213_095854

**项目路径**: `G:\C++\Filesearch\暂存`
...
HeaderBar::HeaderBar(QWidget* parent) : QWidget(parent) {
    ...
    btnAddCenter->setToolTip(StringUtils::wrapToolTip("新建笔记 (Ctrl+N)"));
    ...
    btnTool->setToolTip(StringUtils::wrapToolTip("工具箱 (右键快捷设置)"));
    ...
    btnLock->setToolTip(StringUtils::wrapToolTip("全局锁定"));
    ...
    m_btnStayOnTop->setToolTip(StringUtils::wrapToolTip("始终最前 (自动置顶)"));
    ...
    m_btnMeta->setToolTip(StringUtils::wrapToolTip("元数据面板 (Ctrl+I)"));
    ...
    m_btnFilter->setToolTip(StringUtils::wrapToolTip("高级筛选 (Ctrl+G)"));
...
namespace SvgIcons {
    inline const QMap<QString, QString> icons = {
        ...
        {"ruler_hor", R"svg(<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12h20M2 10v4m20-4v4"/></svg>)svg"},
        {"ruler_ver", R"svg(<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20M10 2h4m-4 20h4"/></svg>)svg"},
...
QWidget* TagEditorWidget::createChip(const QString& tag) {
    ...
    btnClose->setToolTip(StringUtils::wrapToolTip("移除标签"));
